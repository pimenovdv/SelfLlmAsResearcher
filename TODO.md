...
- [x] Добавить функцию compute_parameter_theil_index в src/experiment_utils.py и написать тесты.
- [x] Добавить функцию compute_gradient_theil_index в src/experiment_utils.py и написать тесты.
- [x] Добавить функцию compute_activation_theil_index в src/experiment_utils.py и написать тесты.
