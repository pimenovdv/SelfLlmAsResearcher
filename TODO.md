...
- [x] Добавить функцию compute_parameter_empirical_rule в src/experiment_utils.py и написать тесты.
- [x] Добавить функцию compute_gradient_empirical_rule в src/experiment_utils.py и написать тесты.
- [x] Добавить функцию compute_activation_empirical_rule в src/experiment_utils.py и написать тесты.
