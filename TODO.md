...
- [ ] Использование Activation Patching для поиска слоев/голов, ответственных за задачу Greater-Than.
- [ ] Локализация специфичных голов (например, "Greater-Than Heads" или аналогичных компонентов) с помощью точечного Ablation.
