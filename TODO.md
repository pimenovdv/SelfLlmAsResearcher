...
- [x] Добавить RAG инструменты или MCP-сервер для получения актуальной документации (например, по `transformer_lens`), если агентам не хватает знаний (реализован базовый mock).
